...
# Default: repeat 50, shared map. Pass --mode shared|percpu to bloom_bench_kern_mc.
...
echo "=== building multicore BPF Bloom insert benchmark ==="
make -s

echo "=== running multi-core kernel BPF bloom insert (repeat=${REPEAT}) ==="
